...
HD_PWD='H:/Desktop/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ComboLock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ComboLock.tcl -notrace
